...
import { QianzhengApi } from '../../apis/qianzheng.api';
...
class Content extends AppBase {
  ...
  htuploadimg() {
    var that = this;
    this.Base.uploadImage("qzhuzhao", (ret) => {
  ...
  formSubmit(e) {
    ...
    var leixing = e.detail.value.leixing;
    ...
    if (name == null || name == '') {
      ...
      var qianzhengApi = new QianzhengApi();
      qianzhengApi.qianzheng({
        'name': name,
        'phone': phone,
        'guojia': guojia,
        'leixing': leixing,
