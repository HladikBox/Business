...
export class OrderApi{
    ...
    cancelorder(json, callback, showLoading = true) {
        ...
        console.log(json);
        wx.request({
            url: ApiConfig.GetApiUrl() + 'order/cancelorder',
            data: json,
            method: 'POST',
            dataType: 'json',
            header: header,
    ...
    getmyorder(json, callback, showLoading = true) {
        ...
        console.log(json);
        wx.request({
            url: ApiConfig.GetApiUrl() + 'order/getmyorder',
            data: json,
            method: 'POST',
            dataType: 'json',
            header: header,
    ...
    orderinfo(json, callback, showLoading = true) {
        ...
        console.log(json);
        wx.request({
            url: ApiConfig.GetApiUrl() + 'order/orderinfo',
            data: json,
            method: 'POST',
            dataType: 'json',
            header: header,
